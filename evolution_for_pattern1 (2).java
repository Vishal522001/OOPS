//Getting the evolutions for pattern 1 // 
package homework2; // Name of the Package//
import java.awt.Color; //Importing from the library//
import java.util.Scanner;
import processing.core.PApplet;
public class evolution_for_pattern1 extends PApplet //Name of the class//
{  
    ...
    public static void main(String[] args)
    {
    	...
    	int gen=sc.nextInt();
    	PApplet.main(evolution_for_pattern1.class);  
